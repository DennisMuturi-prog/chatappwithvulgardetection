...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mviewerusername=findViewById(R.id.viewusername);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                mviewerusername.setText(muserprofile.getUsername());
            }
        ...
        mmovetoupdateprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("nameofuser",mviewerusername.getText().toString());
                startActivity(intent);
