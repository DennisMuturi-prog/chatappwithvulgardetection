...
public class setProfile extends AppCompatActivity {
    ...
    ProgressBar mprogreessbarofsetprofile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mprogreessbarofsetprofile=findViewById(R.id.progressbarofsetProfile);
        ...
        msaveprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(name.isEmpty()){
                    ...
                    mprogreessbarofsetprofile.setVisibility(View.VISIBLE);
                    sendDataForNewUser();
                    mprogreessbarofsetprofile.setVisibility(View.INVISIBLE);
